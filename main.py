...
def insert_initial_data():
    ...
    orders = [
        ('ORD-2026-001', 1, '2026-01-15', '2026-02-01', 'В обработке', 4250.00, 'Срочная заявка'),
        ('ORD-2026-002', 2, '2026-01-20', '2026-02-10', 'Новая', 7800.00, ''),
        ('ORD-2026-003', 3, '2026-01-25', '2026-02-15', 'Готова к отгрузке', 323200.00, 'Проверить сроки')
    ]
    ...
    order_items = [
        (1, 1, 3, 850.00, 2550.00, '2026-01-15'),
        (1, 4, 2, 780.00, 1560.00, '2026-06-20'),
        (1, 8, 2, 450.00, 900.00, '2026-07-01'),
        (2, 2, 5, 1200.00, 6000.00, '2026-02-10'),
        (2, 3, 3, 650.00, 1950.00, '2026-01-15'),
        (3, 6, 1, 350000.00, 350000.00, '2026-01-20'),
        (3, 7, 1, 320000.00, 320000.00, '2026-01-20'),
        (3, 9, 2, 1650.00, 3300.00, '2026-05-15')
    ]
